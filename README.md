# Домашнее задание к занятию «Система мониторинга Zabbix» - `Старцев Данила Антонович`
...
apt install -y zabbix-server-pgsql zabbix-frontend-php php8.3-pgsql zabbix-apache-conf zabbix-sql-scripts zabbix-agent
...
Скриншот-2 к заданию 2
![alt text](https://github.com/MindMaze74/zabbix_dz/blob/main/img/4.jpg)
